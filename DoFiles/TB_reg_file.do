...
vlog -sv -work work +incdir+../../rtl {../../tb/tb_reg_file.sv}

vsim -gui work.tb_reg_file


add wave -position end  				sim:/tb_reg_file/dut/clk
add wave -position end  				sim:/tb_reg_file/dut/rst_n
add wave -position end  -radix decimal	sim:/tb_reg_file/dut/avs_s0_address
add wave -position end  				sim:/tb_reg_file/dut/avs_s0_write
add wave -position end  				sim:/tb_reg_file/dut/avs_s0_read
add wave -position end  				sim:/tb_reg_file/dut/avs_s0_writedata
add wave -position end  -radix decimal	sim:/tb_reg_file/dut/a
add wave -position end  -radix decimal	sim:/tb_reg_file/dut/b
run -all
